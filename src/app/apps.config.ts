...
export const APPS: AppConfig[] = [
  ...
  },
  {
    ...
    ios: {
      stage: 'production',
      storeUrl: 'https://apps.apple.com/us/app/sudoku-a-brain-gym/id6759901979',
    },
    accent: '#2563eb',
    accentLight: '#dbeafe',
    accentDark: '#1e3a8a',
  ...
  },
  {
    ...
    android: { stage: 'production', storeUrl: 'https://play.google.com/store/apps/details?id=com.ashutosh.mindfultennis' },
    ios: { stage: 'production', storeUrl: 'https://apps.apple.com/us/app/mindful-tennis/id6760928210' },
    accent: '#059669',
    accentLight: '#d1fae5',
    accentDark: '#064e3b',
